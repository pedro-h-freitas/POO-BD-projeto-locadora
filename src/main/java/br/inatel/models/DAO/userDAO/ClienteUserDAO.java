...
public class ClienteUserDAO extends UserDAO<Cliente> {
    ...
    /**
     * Método para mapear um ResultSet em um Cliente
    ...
    /**
     * Método para obter a query de deleção específica para a tabela de cliente
    ...
    /**
     * Método para obter a query para selecionar o nome de um cliente
